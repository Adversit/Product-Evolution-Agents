// Top context bar — breadcrumb + per-screen mono crumb + PM avatar.
  ...
  return (
    <header style={{ height: 56, flexShrink: 0, background: "rgba(255,255,255,.82)", backdropFilter: "blur(8px)", borderBottom: "1px solid #ECECEA", display: "flex", alignItems: "center", padding: "0 26px", gap: 14 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "#56595F" }}>
        <span style={{ fontWeight: 600, color: "#1B1C1E" }}>RAGFlow</span>
        <span style={{ color: "#D8D8D6" }}>/</span>
        <span>文件上传与问答质量</span>
        <span style={{ fontSize: 10.5, fontWeight: 600, color: "#56595F", background: "#F4F4F3", border: "1px solid #E6E6E4", padding: "1px 7px", borderRadius: 5, marginLeft: 2 }}>growth</span>
      </div>
      <div style={{ flex: 1 }} />
